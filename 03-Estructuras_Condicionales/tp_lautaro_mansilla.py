...
#número par"; en caso contrario, imprimir por pantalla "Por favor, ingrese un número par". Nota: investigar el uso del operador de módulo (%) en Python 
...
if edad < 12:
    print("Peteneces a la categoria Niño/a")
elif edad >= 12 and edad < 18:
    print("Peteneces a la categoria Adolescente")
elif edad >= 18 and edad < 30:
    print("Peteneces a la categoria Adulto/a")
elif edad >= 30: 
    print("Peteneces a la categoria Adulto/a")
else: 
...
# adecuada, imprimir por en pantalla el mensaje "Ha ingresado una contraseña correcta"; en caso contrario, imprimir por pantalla "Por favor, ingrese una contraseña de entre 8 y 14 caracteres".
...
contraseña = input("Ingres su contraseña: ")
...
# El programa debe transformar el nombre ingresado de acuerdo a la opción seleccionada por el usuario e imprimir el resultado por pantalla. Nota: investigue 
# so de las funciones upper(), lower() y title() de Python para convertir entre mayúsculas y minúsculas.
